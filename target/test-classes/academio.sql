...
CREATE TABLE courses (
  ...
  courseLevel int(6) NOT NULL,
  teacher int(6) NOT NULL,
  agendaFileName varchar(300) DEFAULT NULL
);
...
ALTER TABLE courses ADD CONSTRAINT courses_ibfk_2 FOREIGN KEY (courseLevel) REFERENCES course_levels (id);
